...
class DummyContractV2Tests : TestDependencyInjectionBase() {
    ...
    fun `upgrade from v1`() {
        ...
        val v1State = TransactionState(DummyContract.SingleOwnerState(0, ALICE), DummyContract.PROGRAM_ID, DUMMY_NOTARY)
        ...
        val expectedOutput = TransactionState(contractUpgrade.upgrade(v1State.data), DummyContractV2.PROGRAM_ID, DUMMY_NOTARY)
